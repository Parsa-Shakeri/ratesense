...
<body>
  ...
  <main class="wrap">
    ...
    <section id="liveRates" class="card">
      ...
      <div class="muted">
        Sources: Freddie Mac PMMS archive and U.S. Treasury daily yield curve. :contentReference[oaicite:3]{index=3}
      </div>
    </section>
    ...
    <section id="stress" class="card">
      ...
      <p class="muted">
        Simulates interest rate changes over time (like an adjustable-rate reset). Each time the rate changes,
        the payment is re-calculated to amortize the remaining balance over the remaining term.
      </p>
        ...
        <div class="box">
          ...
          <div class="results">
            ...
            <div class="resultCard">
              ...
              <div class="s">Based on % jump from starting payment.</div>
            </div>
            <div class="resultCard">
    ...
    <section id="about" class="card">
      ...
      <div class="twoCol">
        <div class="box">
          ...
          <p>
            ...
            payoff time, and total interest. Most calculators are single-scenario and do not support
          ...
          <ul class="bullets">
            ...
            <li>Live rate pull (best-effort fetch with fallback).</li>
        ...
        <div class="box">
          ...
          <ul class="bullets">
            ...
            <li>Stress test simulates resets: when APR changes, payment re-amortizes remaining balance over remaining term.</li>
            <li>Credit card uses a simple minimum-payment approximation (2% or $25, with safety rules).</li>
            <li>Live rates are pulled from official published sources when available in-browser.</li>
          </ul>

          <h4>How to talk about this in interviews</h4>
          <ul class="bullets">
            <li>“I built an interactive finance tool that turns rate headlines into dollar impact and risk.”</li>
            <li>“I added a stress test to model rate paths, not just one rate.”</li>
      ...
      <div class="muted">
        Sources: Freddie Mac PMMS and U.S. Treasury yield curve. :contentReference[oaicite:4]{index=4}
      </div>
    </section>
